...
public class MemberRestController {
	...
	@PostMapping("/{idx}")
	public int edit(@PathVariable("idx") int idx, MemberEditRequest editRequest, HttpServletRequest request) {
	...
	public int delete(@PathVariable("idx") int idx, HttpServletRequest request) {
		return deleteService.deleteMember(idx, request);
	}
